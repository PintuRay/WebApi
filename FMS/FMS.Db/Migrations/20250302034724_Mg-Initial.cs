        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: true, defaultValueSql: "true"),
                    TokenValue = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: true, defaultValueSql: "true"),
                    CreatedDate = table.Column<DateTime>(type: "timestamptz", nullable: true, defaultValue: new DateTime(2025, 3, 2, 3, 47, 21, 794, DateTimeKind.Utc).AddTicks(5260)),
                    ModifyDate = table.Column<DateTime>(type: "timestamptz", nullable: true, defaultValue: new DateTime(2025, 3, 2, 3, 47, 21, 794, DateTimeKind.Utc).AddTicks(7579)),
                    CreatedBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ModifyBy = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fk_AdressId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Address_Fk_AdressId",
                        column: x => x.Fk_AdressId,
                        principalSchema: "public",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Branches_Address_Fk_AdressId",
                        column: x => x.Fk_AdressId,
                        principalSchema: "public",
                        principalTable: "Address",
                        principalColumn: "AddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlternateUnitName = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Labours_Address_Fk_AdressId",
                        column: x => x.Fk_AdressId,
                        principalSchema: "public",
                        principalTable: "Address",
                        principalColumn: "AddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Parties_Address_Fk_AdressId",
                        column: x => x.Fk_AdressId,
                        principalSchema: "public",
                        principalTable: "Address",
                        principalColumn: "AddressId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("e02eb064-def5-434a-8798-6f144a54003c"), "IN", "India", null, new DateTime(2025, 3, 2, 3, 47, 21, 804, DateTimeKind.Utc).AddTicks(2538), true, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("022df470-aaa9-4f6d-895a-75f41906f76a"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(2129), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Delhi (UT)" },
                    { new Guid("188ab651-af96-41d2-adc4-0af044e6d056"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1793), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Chhattisgarh" },
                    { new Guid("1f2ad09e-7095-4050-b653-ae2d5693fb22"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1874), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Manipur" },
                    { new Guid("2316471c-4fc5-43ee-b20c-94e5c5775514"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1810), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Gujarat" },
                    { new Guid("2898a196-c192-40b6-9865-f7aa4018681c"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(2012), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Tripura" },
                    { new Guid("2b525373-afcc-4fb1-9525-495db02029f8"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1956), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Rajasthan" },
                    { new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1947), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Odisha" },
                    { new Guid("43d58903-126e-4aca-8289-b3d09c7a1e14"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1984), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Telangana" },
                    { new Guid("4a49b1dc-6f18-4de7-85ec-46563a4b5b56"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(2057), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Uttarakhand" },
                    { new Guid("4ecafa26-9eb1-47a6-a927-a23f8f3c4833"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(2145), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Lakshadweep (UT)" },
                    { new Guid("559b5985-bdd4-4dab-8aa7-1887ef7b2c98"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(2068), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "West Bengal" },
                    { new Guid("5ed4f9b3-f38a-4ae9-a738-6f1b3ee50a88"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1860), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Madhya Pradesh" },
                    { new Guid("65afd736-c385-4f57-b667-de4e77f4c9d5"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1952), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Punjab" },
                    { new Guid("67c9f3a9-9235-428a-8463-a743f711a5a3"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(953), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Andhra Pradesh" },
                    { new Guid("6ad24792-a695-43ba-89e3-eda8c1fd7a20"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1942), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Nagaland" },
                    { new Guid("77536c53-345c-48f5-a175-07a7b4044754"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(2100), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Jammu & Kashmir (UT)" },
                    { new Guid("802047bc-496c-4a69-a786-5ba566f8b06b"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1867), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Maharashtra" },
                    { new Guid("970ec112-ce5e-4f5b-9707-be75c379d803"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1715), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Assam" },
                    { new Guid("9a41572b-ac7a-4234-af77-6d6e426e88ef"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1930), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Mizoram" },
                    { new Guid("9f0240ba-79fa-47c5-86f6-e4f3d2ee10d8"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1724), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Bihar" },
                    { new Guid("a14644a8-9c2f-4aa6-8332-9cb576c4dc8c"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1926), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Meghalaya" },
                    { new Guid("abe258b7-a358-42cc-8cce-657dfe4d6644"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(2156), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Andaman and Nicobar Islands (UT)" },
                    { new Guid("ad98660a-f208-4194-82fa-9e74747b2a02"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1968), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Sikkim" },
                    { new Guid("b176f1fe-daba-406f-9256-e6ee6ecd52ed"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1834), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Jharkhand" },
                    { new Guid("b2d8b019-f729-4bac-8006-9b46a307153c"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1842), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Karnataka" },
                    { new Guid("b4b9acf3-87a2-4f5f-95a0-872c0680fb1e"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1801), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Goa" },
                    { new Guid("c2d0c6c5-6954-4921-9d64-90261de50f5e"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1974), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Tamil Nadu" },
                    { new Guid("c9fbd62c-a7fc-4f5e-a44e-2c9fffe94c8f"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(2108), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Ladakh (UT)" },
                    { new Guid("d1459e60-a200-440a-9862-6a6c26bf37ea"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1818), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Haryana" },
                    { new Guid("d84eaae8-09fb-4d80-9303-d166529bde20"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1850), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Kerala" },
                    { new Guid("db5157fd-b616-418b-82e9-3d5f109d69f8"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(2117), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Chandigarh (UT)" },
                    { new Guid("df18be70-0ba6-4918-8351-bf992e4ee17a"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(2138), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Puducherry (UT)" },
                    { new Guid("e691660f-bb06-416a-a79c-9ef41e67ad11"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1701), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Arunachal Pradesh" },
                    { new Guid("e7c6a407-a7f8-4711-b8ff-e57d7b93cafa"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(1826), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Himachal Pradesh" },
                    { new Guid("eaf9a3cc-a650-429e-bcc5-406257614dfa"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(2086), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Daman & Diu (UT)" },
                    { new Guid("f20c53dc-ba9a-4fd6-82cd-63c76fb11cc5"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(2051), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Uttar Pradesh" },
                    { new Guid("fc5486fe-aa06-46f0-9d93-b6a4f71429a2"), null, new DateTime(2025, 3, 2, 3, 47, 21, 819, DateTimeKind.Utc).AddTicks(2078), new Guid("e02eb064-def5-434a-8798-6f144a54003c"), true, null, "Dadra and Nagar Haveli (UT)" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00191050-6e42-4aec-8df4-5a4dda8479ee"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(4470), "Angul", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("05111caa-801f-4201-8169-ceaa54a74e51"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5093), "Balangir", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("061206dc-39d7-4d0e-a72a-3c058014347b"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5103), "Balasore", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("1aaf6c72-3308-4c01-8caf-b9fdfb79e964"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5170), "Bargarh", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("2cc4b79c-ea4c-4433-86a5-f8d1ca1b22d3"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5178), "Bhadrak", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("2f95b1ff-8ddc-415e-9617-b7ccecfaf595"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5192), "Boudh", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("40d9d1a4-ad94-4f14-a23f-d4ec3317d8f9"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5199), "Cuttack", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("4f6f5c1f-8cd9-4cfa-9fbc-4cf2baf9af37"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5205), "Debagarh", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("545de00f-a0d8-4e26-a028-b871849523a0"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5212), "Dhenkanal", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("5b458db9-4fb2-47fd-b22f-e931b5c403fc"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5220), "Gajapati", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("5d7bd772-5210-4790-8ab2-45b1282b8b70"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5230), "Ganjam", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("5e9856e9-f413-4bfc-b18c-33d2d95bee8f"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5238), "Jagatsinghapur", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("63ed7f68-2550-4f5a-b5f8-edd290ff4a43"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5279), "Jajpur", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("651b4906-a3c0-4085-a995-d95557ce4fe9"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5286), "Jharsuguda", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("655f35d9-d2aa-4c62-95b2-eb95cf5480e4"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5293), "Kalahandi", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("6fa770a9-5ba3-4cee-9b9d-67f4d70c558c"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5301), "Kandhamal", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("7244c798-e695-4edc-9894-87e5ff4944e2"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5397), "Sundargarh", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("a00b3a52-cdb5-4e6e-afc5-474f66614a8c"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5391), "Subarnapur", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("a266f1cb-cbd1-4d3e-9c09-2c13cd85c19a"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5384), "Sambalpur", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("b4e62c5b-42db-4eb6-b120-cb0d15ca8f48"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5378), "Rayagada", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("ca257efa-7b94-4e20-8938-bbb810185d8e"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5371), "Puri", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("d4b11083-8f76-4ff9-86c6-56719c6762f0"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5363), "Nuapada", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("d71bbbc0-f66c-4951-b27b-5b6536f03fa8"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5355), "Nayagarh", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("d77c8178-6678-4f4b-961e-a167a3681efd"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5348), "Nabarangpur", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("d979569b-cf54-4861-b9fd-7c36921237d4"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5340), "Mayurbhanj", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("dd205972-117a-4a46-9727-6cad22ce7ebe"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5333), "Malkangiri", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("e1e34023-313b-4c1b-a72d-e0895a9ce87a"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5327), "Koraput", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("f25f937c-30e3-4d30-b54e-fc4377257987"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5321), "Khordha", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("f270c1c1-82c5-4171-a491-6c89eec056ec"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5313), "Kendujhar", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null },
                    { new Guid("f4a67a44-27b9-44f9-9f29-f75a3bf6c625"), null, new DateTime(2025, 3, 2, 3, 47, 21, 833, DateTimeKind.Utc).AddTicks(5306), "Kendrapara", new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), true, null }
                });

            migrationBuilder.InsertData(
                schema: "public",
                table: "Address",
                columns: new[] { "AddressId", "At", "City", "CreatedBy", "Fk_CountryId", "Fk_DistId", "Fk_StateId", "ModifyBy", "OtherDetails", "PinCode", "Post" },
                values: new object[] { new Guid("c9b62c55-1b06-485d-a71b-d92fee4f4428"), "DHANAMANDAL", "CUTTACK", null, new Guid("e02eb064-def5-434a-8798-6f144a54003c"), new Guid("40d9d1a4-ad94-4f14-a23f-d4ec3317d8f9"), new Guid("2d1ea7cb-cf85-4be6-bdda-422e99bea59e"), null, null, "754018", "BRAHMANSAILO" });

            migrationBuilder.InsertData(
                schema: "public",
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "BirthDate", "ConcurrencyStamp", "Email", "EmailConfirmed", "Fk_AdressId", "Fk_TokenId", "Gender", "LockoutEnabled", "LockoutEnd", "MaratialStatus", "Name", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "PhotoPath", "SecurityStamp", "TermCondition", "TwoFactorEnabled", "UserName" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "71f97dea-8c5f-4f51-84c7-6d7a16e64651", "4431f16a-6bc7-4e9b-bada-c491fcc81a58", "System", new DateTime(2025, 3, 2, 3, 47, 21, 632, DateTimeKind.Utc).AddTicks(3049), "AppUserRole", "System", new DateTime(2025, 3, 2, 3, 47, 21, 632, DateTimeKind.Utc).AddTicks(8549) });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_Fk_AdressId",
                schema: "public",
                table: "AspNetUsers",
                column: "Fk_AdressId",
                unique: true);
