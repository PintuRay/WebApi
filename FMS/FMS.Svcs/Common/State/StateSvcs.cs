        ...
        public async Task<SvcsBase> BulkRemoveState(List<StateUpdateModel> listdata, AppUser user)
        {
            ...
            try
            {
                ...
                Obj = repoResult.IsSucess switch
                {
                    ...
                    {
                        Data = repoResult.Records,
                        Message = $"{((List<Db.Entity.StateDto>)repoResult.Records).Count} removed, {listdata.Count - ((List<Db.Entity.StateDto>)repoResult.Records).Count} failed",
                        ResponseCode = (int)ResponseCode.Status.Ok,
                    },
                    false => new()
                    {
        ...
        public async Task<SvcsBase> BulkRecoverStates(List<StateUpdateModel> listdata, AppUser user)
        {
            ...
            try
            {
                ...
                Obj = repoResult.IsSucess switch
                {
                    ...
                    {
                        Data = repoResult.Records,
                        Message = $"{((List<Db.Entity.StateDto>)repoResult.Records).Count} recovered, {listdata.Count - ((List<Db.Entity.StateDto>)repoResult.Records).Count} failed",
                        ResponseCode = (int)ResponseCode.Status.Ok,
                    },
                    false => new()
                    {
