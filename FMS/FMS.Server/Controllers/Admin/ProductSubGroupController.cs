...
namespace FMS.Server.Controllers.Admin
{
    ...
    public class ProductSubGroupController(IAdminSettingSvcs adminSvcs, UserManager<AppUser> userManager) : ControllerBase
    {
        #region Dependancy
        ...
        [HttpDelete, Route("ProductSubgroupid/{id}"), Authorize(policy: "Delete")]
