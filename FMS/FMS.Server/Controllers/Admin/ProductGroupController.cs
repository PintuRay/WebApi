...
namespace FMS.Server.Controllers.Admin
{
    ...
    public class ProductGroupController(IAdminSettingSvcs adminSvcs, UserManager<AppUser> userManager) : ControllerBase
    {
        #region Dependancy
        ...
        [HttpDelete, Route("ProductGroupid/{id}"), Authorize(policy: "Delete")]
