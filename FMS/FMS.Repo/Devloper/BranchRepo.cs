...
{
    public class BranchRepo(Context ctx, IMapper mapper, ICustomCache cache): IBranchRepo
    {
        #region Dependancy
        ...
        #region Branch
        #region Crud
        public async Task<Result<Branch>> GetAllBranch(PaginationParams pagination)
        {
            Result<Branch> _Result = new();
            List<Branch> Query = new();
            try
            {
        ...
        public async Task<RepoBase> CreateBranch(BranchModel data, AppUser user)
        {
            ...
            try
            {
                ...
                if (Query == null)
                {
                    var newBranch = _mapper.Map<Branch>(data);
        ...
        #endregion
        #region Recover
        public async Task<Result<Branch>> GetRemovedBranches(PaginationParams pagination)
        {
            Result<Branch> _Result = new();
            List<Branch> Query = new();
            try
